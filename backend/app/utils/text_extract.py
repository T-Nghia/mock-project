...
VIETNAMESE_STOPWORDS = {
    "về", "của", "là", "và", "trong", "cho", "như", "được", "các", "những",
    "với", "theo", "bởi", "ra", "vào", "tại", "đến", "từ", "ở", "này", "đó"
}


def embed_text(text: str) -> list[float]:
    """
    Deterministic pseudo-embedding based on token hashing (unigrams + bigrams - stopwords).
    ...
    words = [
        ...
        if w not in VIETNAMESE_STOPWORDS and len(w) > 1
    ]
