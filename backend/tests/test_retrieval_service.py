...
class FakeRetrievalRepository:
    ...
    def retrieve_chunks(self, *, document_id, user_id, query_embedding, top_k):
...
class RetrievalServiceTestCase(unittest.TestCase):
    def test_retrieve_embeds_trimmed_question_and_passes_arguments(self):
        ...
        self.assertEqual(fake_repo.user_id, user_id)
    ...
    def test_empty_question_is_rejected(self):
        ...
        with self.assertRaises(ValueError):
            service.retrieve(document_id=uuid.uuid4(), user_id=uuid.uuid4(), question="   ")
